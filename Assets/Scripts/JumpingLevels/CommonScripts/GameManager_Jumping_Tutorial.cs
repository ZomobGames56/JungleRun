...
public class GameManager_Jumping_Tutorial : MonoBehaviour
{
    public static GameManager_Jumping_Tutorial Instance { get; set; }
    ...
    void Start()
    {
        ...
        forwardMovement_Jumping_Tutorial = player.GetComponent<ForwardMovement_Jumping_Tutorial>();
        ...
        startScreenHighScore.text = "---";
        inGameScreenHighScore.text = "---";
    ...
    IEnumerator StartingAnim()
    {
        ...
        //     // playerMovement?.Invoke(false, "Left", new Vector3(-4f, -0.9f, 48f));
        // }
        // else
        // {
        //     rb.isKinematic = true;
        ...
        //     // playerMovement?.Invoke(true, "Centre", new Vector3(0f, -0.9f, -7.6f));
        // }
